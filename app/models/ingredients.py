...
class GitaVerse(BaseIngredient):
    ...
    # ── Sanskrit layers ───────────────────────────────────────────────────────
    sanskrit_text: str = Field(..., description="Original Devanagari script.")
    transliteration: str = Field(..., description="Roman-script phonetic rendering.")
    english_translation: str = Field(..., description="Literal English translation.")
